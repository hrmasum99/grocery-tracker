...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
      {/* Show Navbar if user is logged in, otherwise show simple nav */}
      {user ? (
        <Navbar />
      ) : (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, idx) => (
              <Card
                key={idx}
                className="p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeIn"
...
const AuthModal = ({ isOpen, onClose, isLogin, setIsLogin, onLogin }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pointer-events-none">
        <div 
          className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full overflow-hidden grid md:grid-cols-2 pointer-events-auto" 
